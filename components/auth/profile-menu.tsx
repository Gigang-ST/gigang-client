      ...
      {isOpen ? (
        ...
        >
          <Link
            ...
            className="flex h-8 w-full items-center rounded-md px-3 text-sm text-white hover:bg-white/10"
          >
            프로필
          </Link>
          <LogoutButton
            variant="ghost"
            size="sm"
            className="h-8 w-full justify-start rounded-md px-3 text-sm font-normal text-white hover:bg-white/10 hover:text-white"
          />
        </div>
      ) : null}
    </div>
