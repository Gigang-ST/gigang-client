...
function BannerGate({
  ...
  return (
    <>
      {children}
      {createPortal(
      <div className="app-fixed pointer-events-auto fixed inset-x-0 bottom-0 z-[9999] flex items-center gap-2 bg-primary px-4 py-3 text-primary-foreground" style={{ paddingBottom: "calc(0.75rem + env(safe-area-inset-bottom, 0px))" }}>
