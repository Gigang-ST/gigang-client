...
function initBankData(m: { id: string; full_name: string; bank_name: string; bank_account: string }): BankData {
...
export default function BankInfoPage() {
  ...
  const [data, setData] = useState<BankData | null>(
    member ? initBankData(member) : null,
  );
